...
* [mysql](./dialect/mysql/mysql.go) - `import _ "github.com/SkelatorIndy/goqu/v9/dialect/mysql"`
* [postgres](./dialect/postgres/postgres.go) - `import _ "github.com/SkelatorIndy/goqu/v9/dialect/postgres"`
* [sqlite3](./dialect/sqlite3/sqlite3.go) - `import _ "github.com/SkelatorIndy/goqu/v9/dialect/sqlite3"`
* [sqlserver](./dialect/sqlserver/sqlserver.go) - `import _ "github.com/SkelatorIndy/goqu/v9/dialect/sqlserver"`
...
import (
  "fmt"
  "github.com/SkelatorIndy/goqu/v9"
  // import the dialect
  _ "github.com/SkelatorIndy/goqu/v9/dialect/postgres"
)
...
import (
  ...
  "github.com/SkelatorIndy/goqu/v9"
  // import the dialect
  _ "github.com/SkelatorIndy/goqu/v9/dialect/mysql"
)
...
import (
  ...
  "github.com/SkelatorIndy/goqu/v9"
  // import the dialect
  _ "github.com/SkelatorIndy/goqu/v9/dialect/sqlite3"
)
...
import (
  ...
  "github.com/SkelatorIndy/goqu/v9"
  // import the dialect
  _ "github.com/SkelatorIndy/goqu/v9/dialect/sqlserver"
)
...
Most SQL dialects share a majority of their syntax, for this reason `goqu` has a [default set of dialect options]((http://godoc.org/github.com/SkelatorIndy/goqu/#DefaultDialectOptions)) that can be used as a base for any new Dialect.

When creating a new `SQLDialect` you just need to override the default values that are documented in [`SQLDialectOptions`](http://godoc.org/github.com/SkelatorIndy/goqu/#SQLDialectOptions).
...
When creating a new dialect you must register it using [`RegisterDialect`](http://godoc.org/github.com/SkelatorIndy/goqu/#RegisterDialect). This method requires 2 arguments.
